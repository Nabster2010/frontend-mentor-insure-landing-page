...
const Features = () => {
  return (
    <section className="px-4 md:px-16 lg:px-24 bg-transparent text-center md:text-start mt-36 md:mt-96">
      <h1 className="text-5xl md:text-7xl font-DmSerif text-VeryDarkViolet ">
        We're different
      </h1>
      <div className="flex flex-col md:flex-row justify-start items-center md:items-stretch mt-24 gap-16 md:gap-4 ">
        <div className="flex-1 flex flex-col items-center md:items-start max-w-md text-center md:text-start">
          <svg
            width="100"
            height="100"
            viewBox="0 0 86 86"
          ...
          <h3 className="text-3xl  font-DmSerif mt-8 text-VeryDarkViolet">
            Snappy Process
          </h3>
          <p className="text-DarkGrayishViolet mt-6">
