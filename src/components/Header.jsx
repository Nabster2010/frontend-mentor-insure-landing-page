...
const Header = () => {
  ...
  return (
    <header
      className={` ${
        menuOpen && "fixed top-0 left-0 w-full bg-white"
      } md:px-24 px-6 py-4 md:py-8`}
    >
      <nav className="flex  flex-row justify-between items-center">
        ...
        <ul className=" hidden md:flex justify-center items-center gap-8 text-DarkGrayishViolet  font-bold">
          <li>
            <a
              className="hover:text-VeryDarkViolet transition whitespace-nowrap"
              href="#"
            >
              HOW WE WORK
            </a>
          ...
          <li>
            <a className="hover:text-VeryDarkViolet transition " href="#">
              BLOG
            </a>
          </li>
          <li>
          ...
          <li>
            <a
              className="whitespace-nowrap border-black border-2 px-8 py-3 hover:bg-black hover:text-white transition"
              href="#"
            >
              VIEW PLANS
            </a>
        ...
        <div
          ...
          } bg-VeryDarkViolet  justify-center items-start z-30 fixed top-16 left-0 right-0 h-[calc(100vh-4rem)]  overflow-y-hidden px-6 py-10`}
        >
          <ul className="flex-1 flex flex-col justify-center items-center gap-8 text-white  font-bold">
            <li>
              <a
                className="hover:text-DarkGrayishViolet transition whitespace-nowrap"
                href="#"
              >
                HOW WE WORK
              </a>
            ...
            <li>
              <a className="hover:text-DarkGrayishViolet transition " href="#">
                BLOG
              </a>
            </li>
            <li>
            ...
            <li className="flex-1 w-full ">
              <a
                className="whitespace-nowrap text-center block border-white border-2 px-8 py-3 hover:bg-white hover:text-VeryDarkViolet transition"
                href="#"
              >
                VIEW PLANS
              </a>
